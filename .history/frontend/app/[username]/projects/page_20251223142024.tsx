...
const ProjectsPage: React.FC = () => {
  ...
  const handleAdd = () => {
    let payload: any = { title: form.title, description: form.description, category: form.category, image: form.image };
  ...
  const handleUpdate = () => {
    ...
    let payload: any = { title: form.title, description: form.description, category: form.category };
          ...
          <DialogContent className="w-full max-w-full sm:max-w-md">
            ...
            {title !== "Confirm Delete" ? (
              <div className="space-y-4">
                ...
                <Input value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} placeholder="Project category" />
                <div>
